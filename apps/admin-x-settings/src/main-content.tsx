...
const MainContent: React.FC = () => {
    ...
    return (
        <Page>
            ...
            <div className="relative h-full flex-1 overflow-y-scroll overscroll-y-contain bg-white pt-12 tablet:basis-[800px] dark:bg-grey-950 dark:tablet:bg-black" id="admin-x-settings-scroller">
                <Settings />
            </div>
        </Page>
    );
